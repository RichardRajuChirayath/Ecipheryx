            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <header className="flex flex-col md:flex-row items-center justify-between mb-16 gap-10">
                    <div className="flex items-center gap-6">
                        <Link href="/" className="w-16 h-16 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center backdrop-blur-2xl hover:bg-cyan-500/10 transition-all shadow-lg p-2">
                            <img src="/logo.png" alt="Ecipheryx Logo" className="w-full h-full object-contain" />
                        </Link>
